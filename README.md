...
- [Apache Druid](https://github.com/adbc-drivers/druid) - ADBC driver for Apache Druid developed by the ADBC Driver Foundry.
...
- [chDB](https://clickhouse.com/docs/chdb/install/adbc) - ADBC driver for chDB developed by ClickHouse, Inc.
...
- [DuckDB Quack](https://github.com/adbc-drivers/quack) - ADBC driver for DuckDB Quack developed by the ADBC Driver Foundry.
...
- [Presto](https://github.com/adbc-drivers/presto) - ADBC Driver for Presto developed by the ADBC Driver Foundry.
...
- [Microsoft Fabric](https://www.microsoft.com/en-us/microsoft-fabric/) - Microsoft's end‑to‑end data platform.
- [Microsoft Power BI](https://www.microsoft.com/en-us/power-platform/products/power-bi/) - Microsoft's business analytics platform.
